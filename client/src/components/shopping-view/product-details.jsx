...
function ProductDetailsDialog({ open, setOpen, productDetails }) {
  ...
  return (
    <Dialog open={open} onOpenChange={handleDialogClose}>
     <DialogContent
  className="grid grid-cols-2 gap-8 p-4 sm:p-6 max-w-[90vw] sm:max-w-[80vw] lg:max-w-[70vw] m-4 sm:m-8 max-h-[calc(100vh-4rem)] overflow-auto rounded-lg shadow-lg"
>
  <div className="relative overflow-hidden ">
    <img
      src={productDetails?.image}
      alt={productDetails?.title}
      className="aspect-square object-cover w-80 h-80"
    />
  </div>
  <div className="">
    <div>
